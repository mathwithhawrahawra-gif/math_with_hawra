# Consuming Math With Hawra Design System in Expo apps

Read `artifacts/math-hawra-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/math-hawra-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/math-hawra-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/math-hawra-ds/lib/native-theme";
import { useColors } from "@workspace/math-hawra-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/math-hawra-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/math-hawra-ds/components/native/badge";
import { Button } from "@workspace/math-hawra-ds/components/native/button";
import { Card } from "@workspace/math-hawra-ds/components/native/card";
```
...
Import and render
`@workspace/math-hawra-ds/components/native/button`, then run Expo
