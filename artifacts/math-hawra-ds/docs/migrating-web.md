# Migrating web UI to Math With Hawra Design System

Read `artifacts/math-hawra-ds/docs/AGENTS.md` and
`artifacts/math-hawra-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/math-hawra-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/math-hawra-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/math-hawra-ds/hooks/use-toast`
