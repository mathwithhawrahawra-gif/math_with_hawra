# Migrating Expo UI to Math With Hawra Design System

Read `artifacts/math-hawra-ds/docs/AGENTS.md` and
`artifacts/math-hawra-ds/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/math-hawra-ds/lib/native-theme` and
  `@workspace/math-hawra-ds/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/math-hawra-ds/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/math-hawra-ds` and retains only
