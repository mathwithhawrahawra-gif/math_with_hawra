# Math With Hawra Design System design system
...
workspace package (`@workspace/math-hawra-ds`): other artifacts depend
...
`@workspace/math-hawra-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/math-hawra-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/math-hawra-ds` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/math-hawra-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/math-hawra-ds/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/math-hawra-ds/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/math-hawra-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/math-hawra-ds/docs/migrating-expo.md`
